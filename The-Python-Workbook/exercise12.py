...
t1 = float(input('Insert first latitude: '))
g1 = float(input('Insert first longitude: '))
t2 = float(input('Insert second latitude: '))
g2 = float(input('Insert second longitude: '))

t1_rad = math.radians(t1)
t2_rad = math.radians(g1)
g1_rad = math.radians(t2)
g2_rad = math.radians(g2)

distance = 6371.01 * math.acos(math.sin(t1_rad)*math.sin(t2_rad)+math.cos(
    t1_rad)*math.cos(t2_rad)*math.cos(g1_rad)-g2_rad)
